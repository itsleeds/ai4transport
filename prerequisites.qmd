...
-   Option 1: if you're using a cloud-based development environment:
    ...
    -   Tested out GitHub Codespaces to ensure it works on your machine by opening this link and running the prerequisites code in prerequisites.qmd: <!-- - TODO: update this when new repo is live -->
    -   https://github.com/codespaces/new/tdscience/dstp?quickstart=1

**or, for running the code locally:**

-   A laptop with a the necessary software installed, including:
