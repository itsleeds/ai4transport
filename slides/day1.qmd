...
See powerpoint slides: [github.com/itsleeds/ai4transport/releases](https://github.com/itsleeds/ai4transport/releases/download/v1/aibasics.pptx)
...
-   Finding, cleaning, and visualizing transport data with AI
-   Exploratory Data Analysis (EDA) and interpretation
-   *Note: Originally planned to focus on document analysis. That advanced content is now in [Session 3 Advanced](../s3-advanced.qmd), but we expect most to focus on this updated data analysis session.*
