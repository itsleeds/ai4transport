...
We recommend taking Anthropic's full [AI Fluency course](https://www.anthropic.com/learn/claude-for-you) to deepen your understanding of AI.

If you want more experience with data science:

-   [Geocomputation with R](https://r.geocompx.org/), and the [Transport chapter](https://r.geocompx.org/transport.html) in particular
...
-   [Robin Lovelace](https://environment.leeds.ac.uk/transport/staff/953/professor-robin-lovelace)
-   [Chris Rushton](https://environment.leeds.ac.uk/transport/staff/8835/dr-chris-rushton)

## Data Access

You can find details on how to access the data used in this course on the [Get Data](get-data.qmd) page.
